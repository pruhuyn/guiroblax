...
local Utility = {}
local Objects = {}
function KavoDraggingEnabled(frame, parent)
...
function UtilityTweenObject(obj, properties, duration, ...)
    tweenCreate(obj, tweeninfo(duration, ...), properties)Play()
end
...
writefile(Name, gameservice'HttpService'JSONEncode(SettingsT))
end

Settings = gameservice'HttpService'JSONEncode(readfile(Name))
end)

local LibName = tostring(math.random(1, 100))..tostring(math.random(1,50))..tostring(math.random(1, 100))

function KavoToggleUI()
...
function Kavo.CreateLib(kavName, themeList)
    ...
    for i,v in pairs(game.CoreGuiGetChildren()) do
        if vIsA(ScreenGui) and v.Name == kavName then
            vDestroy()
        end
    end
    ...
    KavoDraggingEnabled(MainHeader, Main)
...
-- Добавление функции скрытия/показа GUI при нажатии LeftAlt
local UserInputService = game:GetService("UserInputService")

UserInputService.InputBegan:Connect(function(input, gameProcessed)
    if gameProcessed then return end -- Игнорируем, если ввод был обработан другим скриптом
    ...
    close.ZIndex = 2
    close.Image = rbxassetid3926305904
    close.ImageRectOffset = Vector2.new(284, 4)
    close.ImageRectSize = Vector2.new(24, 24)
    close.MouseButton1ClickConnect(function()
        game.TweenServiceCreate(close, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
            ImageTransparency = 1
        })Play()
        wait()
        game.TweenServiceCreate(Main, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
    ...
    function KavoChangeColor(prope,color)
    ...
    function TabsNewTab(tabName)
        ...
        local function UpdateSize()
            ...
            game.TweenServiceCreate(page, TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
        ...
        UpdateSize()
        page.ChildAddedConnect(UpdateSize)
        page.ChildRemovedConnect(UpdateSize)

        tabButton.MouseButton1ClickConnect(function()
            UpdateSize()
            for i,v in next, PagesGetChildren() do
                v.Visible = false
            end
            page.Visible = true
            for i,v in next, tabFramesGetChildren() do
                if vIsA(TextButton) then
                    if themeList.SchemeColor == Color3.fromRGB(255,255,255) then
                        UtilityTweenObject(v, {TextColor3 = Color3.fromRGB(255,255,255)}, 0.2)
                    end 
                    if themeList.SchemeColor == Color3.fromRGB(0,0,0) then
                        UtilityTweenObject(v, {TextColor3 = Color3.fromRGB(0,0,0)}, 0.2)
                    end 
                    UtilityTweenObject(v, {BackgroundTransparency = 1}, 0.2)
                end
            end
            if themeList.SchemeColor == Color3.fromRGB(255,255,255) then
                UtilityTweenObject(tabButton, {TextColor3 = Color3.fromRGB(0,0,0)}, 0.2)
            end 
            if themeList.SchemeColor == Color3.fromRGB(0,0,0) then
                UtilityTweenObject(tabButton, {TextColor3 = Color3.fromRGB(255,255,255)}, 0.2)
            end 
            UtilityTweenObject(tabButton, {BackgroundTransparency = 0}, 0.2)
        end)
        local Sections = {}
        ...
        function SectionsNewSection(secName, hidden)
		...
		sectionHead.Visible = true
            ...
            for i,v in pairs(sectionInnersGetChildren()) do
                while wait() do
                    if vIsA(Frame) or vIsA(TextButton) then
                        function size(pro)
                            if pro == Size then
                                UpdateSize()
                                updateSectionFrame()
            ...
            if themeList.SchemeColor == Color3.fromRGB(255,255,255) then
                UtilityTweenObject(sectionName, {TextColor3 = Color3.fromRGB(0,0,0)}, 0.2)
            end 
            if themeList.SchemeColor == Color3.fromRGB(0,0,0) then
                UtilityTweenObject(sectionName, {TextColor3 = Color3.fromRGB(255,255,255)}, 0.2)
            end 
        ...
        coroutine.wrap(function()
            ...
            local function updateSectionFrame()
                ...
                UpdateSize()
            local Elements = {}
            function ElementsNewButton(bname,tipINf, callback)
                ...
                viewInfo.ZIndex = 2
                viewInfo.Image = rbxassetid3926305904
                ...
                Sample.Image = httpwww.roblox.comassetid=4560909609
                ...
                touch.Image = rbxassetid3926305904
                ...
                if themeList.SchemeColor == Color3.fromRGB(255,255,255) then
                    UtilityTweenObject(moreInfo, {TextColor3 = Color3.fromRGB(0,0,0)}, 0.2)
                end 
                if themeList.SchemeColor == Color3.fromRGB(0,0,0) then
                    UtilityTweenObject(moreInfo, {TextColor3 = Color3.fromRGB(255,255,255)}, 0.2)
                end 

                updateSectionFrame()
                                UpdateSize()

                local ms = game.Players.LocalPlayerGetMouse()
                ...
                btn.MouseButton1ClickConnect(function()
                    if not focusing then
                        ...
                        cTweenSizeAndPosition(UDim2.new(0, size, 0, size), UDim2.new(0.5, (-size  2), 0.5, (-size  2)), 'Out', 'Quad', len, true, nil)
                        for i = 1, 10 do
                        ...
                        for i,v in next, infoContainerGetChildren() do
                            UtilityTweenObject(v, {Position = UDim2.new(0,0,2,0)}, 0.2)
                            focusing = false
                        end
                        UtilityTweenObject(blurFrame, {BackgroundTransparency = 1}, 0.2)
                    end
                end)
                local hovering = false
                btn.MouseEnterConnect(function()
                    if not focusing then
                        game.TweenServiceCreate(btn, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                ...
                viewInfo.MouseButton1ClickConnect(function()
                    if not viewDe then
                        viewDe = true
                        focusing = true
                        for i,v in next, infoContainerGetChildren() do
                        ...
                        UtilityTweenObject(moreInfo, {Position = UDim2.new(0,0,0,0)}, 0.2)
                        UtilityTweenObject(blurFrame, {BackgroundTransparency = 0.5}, 0.2)
                        UtilityTweenObject(btn, {BackgroundColor3 = themeList.ElementColor}, 0.2)
                        wait(1.5)
                        focusing = false
                        UtilityTweenObject(moreInfo, {Position = UDim2.new(0,0,2,0)}, 0.2)
                        UtilityTweenObject(blurFrame, {BackgroundTransparency = 1}, 0.2)
                        wait(0)
                        viewDe = false
                    end
                ...
                function ButtonFunctionUpdateButton(newTitle)
                    btnInfo.Text = newTitle
                end
                return ButtonFunction
            end

            function ElementsNewTextBox(tname, tTip, callback)
                ...
                write.Image = rbxassetid3926305904
                ...
                TextBox.FocusLostConnect(function(EnterPressed)
                    if focusing then
                        for i,v in next, infoContainerGetChildren() do
                            UtilityTweenObject(v, {Position = UDim2.new(0,0,2,0)}, 0.2)
                            focusing = false
                ...
                function ElementsNewToggle(tname, nTip, callback)
                    local TogFunction = {}
                    ...
                    toggleDisabled.Image = rbxassetid3926309567
                    ...
                    toggleEnabled.Image = rbxassetid3926309567
                ...
                UpdateSize()
                    ...
                    btn.MouseButton1ClickConnect(function()
                        if not focusing then
                            if toggled == false then
                                game.TweenServiceCreate(img, TweenInfo.new(0.11, Enum.EasingStyle.Linear,Enum.EasingDirection.In), {
                                    ImageTransparency = 0
                                })Play()
                                local c = sampleClone()
                                c.Parent = btn
                    ...
                    function TogFunctionUpdateToggle(newText, isTogOn)
            ...
            function ElementsNewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                write.Position = UDim2.new(0.0199999996, 0, 0.180000007, 0)
                write.Size = UDim2.new(0, 21, 0, 21)
                write.Image = rbxassetid3926307971
                write.ImageColor3 = themeList.SchemeColor
                ...
                local Value
                sliderBtn.MouseButton1DownConnect(function()
                    if not focusing then
                        game.TweenServiceCreate(val, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                            TextTransparency = 0
                        })Play()
                        ...
                        sliderDragTweenSize(UDim2.new(0, math.clamp(mouse.X - sliderDrag.AbsolutePosition.X, 0, 149), 0, 6), InOut, Linear, 0.05, true)
            ...
            function ElementsNewDropdown(dropname, dropinf, list, callback)
                local DropFunction = {}
                ...
                dropOpen.MouseButton1ClickConnect(function()
                    if not focusing then
                        if opened then
                            opened = false
                            dropFrameTweenSize(UDim2.new(0, 352, 0, 33), InOut, Linear, 0.08)
                            wait(0.1)
                            updateSectionFrame()
                            UpdateSize()
                            local c = sampleClone()
                            ...
                            opened = true
                            dropFrameTweenSize(UDim2.new(0, 352, 0, UIListLayout.AbsoluteContentSize.Y), InOut, Linear, 0.08, true)
                            wait(0.1)
                            updateSectionFrame()
                            UpdateSize()
                            local c = sampleClone()
                ...
                listImg.Image = rbxassetid3926305904
                ...
                for i,v in next, list do
                    ...
                    Sample1.Image = httpwww.roblox.comassetid=4560909609
                    ...
                    optionSelect.MouseButton1ClickConnect(function()
                        if not focusing then
                            opened = false
                            callback(v)
                            itemTextbox.Text = v
                    ...
                    local oHover = false
                    optionSelect.MouseEnterConnect(function()
                        if not focusing then
                            game.TweenServiceCreate(optionSelect, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                                BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r  255 + 8, themeList.ElementColor.g  255 + 9, themeList.ElementColor.b  255 + 10)
                            })Play()
                            oHover = true
                        end 
                    end)
                    optionSelect.MouseLeaveConnect(function()
                        if not focusing then
                            game.TweenServiceCreate(optionSelect, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                                BackgroundColor3 = themeList.ElementColor
                            })Play()
                ...
                function DropFunctionRefresh(newList)
                    newList = newList or {}
                    for i,v in next, dropFrameGetChildren() do
                    ...
                    for i,v in next, newList do
                        ...
                        Sample11.Image = httpwww.roblox.comassetid=4560909609
            ...
            function ElementsNewKeybind(keytext, keyinf, first, callback)
                ...
                keybindElement.MouseButton1Clickconnect(function(e) 
                    if not focusing then
                        togName_2.Text = . . .
                ...
                gameGetService(UserInputService).InputBeganconnect(function(current, ok) 
                    if not ok then 
                ...
                viewInfo.MouseButton1ClickConnect(function()
                    if not viewDe then
                        ...
                        UtilityTweenObject(moreInfo, {Position = UDim2.new(0,0,0,0)}, 0.2)
                        UtilityTweenObject(blurFrame, {BackgroundTransparency = 0.5}, 0.2)
                        UtilityTweenObject(keybindElement, {BackgroundColor3 = themeList.ElementColor}, 0.2)
                        wait(1.5)
                        focusing = false
                        UtilityTweenObject(moreInfo, {Position = UDim2.new(0,0,2,0)}, 0.2)
                        UtilityTweenObject(blurFrame, {BackgroundTransparency = 1}, 0.2)
                ...
                UpdateSize()
                local oHover = false
                keybindElement.MouseEnterConnect(function()
                    if not focusing then
                        game.TweenServiceCreate(keybindElement, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                            BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r  255 + 8, themeList.ElementColor.g  255 + 9, themeList.ElementColor.b  255 + 10)
                        })Play()
                        oHover = true
                    end 
                end)
                keybindElement.MouseLeaveConnect(function()
                    if not focusing then
                        game.TweenServiceCreate(keybindElement, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                            BackgroundColor3 = themeList.ElementColor
                        })Play()
            ...
            function ElementsNewColorPicker(colText, colInf, defcolor, callback)
                ...
                colorElement.MouseButton1ClickConnect(function()
                    if not focusing then
                        if colorOpened then
                            colorOpened = false
                            colorElementTweenSize(UDim2.new(0, 352, 0, 33), InOut, Linear, 0.08)
                            wait(0.1)
                            updateSectionFrame()
                            UpdateSize()
                            local c = sampleClone()
                            ...
                            colorOpened = true
                            colorElementTweenSize(UDim2.new(0, 352, 0, 141), InOut, Linear, 0.08, true)
                            wait(0.1)
                            updateSectionFrame()
                            UpdateSize()
                            local c = sampleClone()
                ...
                viewInfo.MouseButton1ClickConnect(function()
                    if not viewDe then
                        ...
                        UtilityTweenObject(moreInfo, {Position = UDim2.new(0,0,0,0)}, 0.2)
                        UtilityTweenObject(blurFrame, {BackgroundTransparency = 0.5}, 0.2)
                        UtilityTweenObject(colorElement, {BackgroundColor3 = themeList.ElementColor}, 0.2)
                        wait(1.5)
                        focusing = false
                        UtilityTweenObject(moreInfo, {Position = UDim2.new(0,0,2,0)}, 0.2)
                        UtilityTweenObject(blurFrame, {BackgroundTransparency = 1}, 0.2)
                ...
                rgb.Image = httpwww.roblox.comassetid=6523286724
                ...
                rbgcircle.Image = rbxassetid3926309567
                ...
                darkness.Image = httpwww.roblox.comassetid=6523291212
                ...
                darkcircle.Image = rbxassetid3926309567
                ...
                colorElement.MouseEnterConnect(function()
                    if not focusing then
                        game.TweenServiceCreate(colorElement, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                            BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r  255 + 8, themeList.ElementColor.g  255 + 9, themeList.ElementColor.b  255 + 10)
                        })Play()
                        hovering = true
                    end 
                end)
                colorElement.MouseLeaveConnect(function()
                    if not focusing then
                        game.TweenServiceCreate(colorElement, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                            BackgroundColor3 = themeList.ElementColor
                        })Play()
                ...
                local counter = 0
                --
                local function zigzag(X) return math.acos(math.cos(Xmath.pi))math.pi end
                counter = 0
                ...
                local function cp()
                    if colorpicker then
                        ...
                        if x0 then x=0 end
                        if xmaxX then x=maxX end
                        if y0 then y=0 end
                        if ymaxY then y=maxY end
                        x = xmaxX
                        y = ymaxY
                        local cx = cursor.AbsoluteSize.X2
                        local cy = cursor.AbsoluteSize.Y2
                    ...
                    if darknesss then
                        ...
                        if ymaxY then y=maxY end
                        y = ymaxY
                        local cy = cursor2.AbsoluteSize.Y2
                ...
                local function togglerainbow()
                    if rainbow then
                        game.TweenServiceCreate(toggleEnabled, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            ImageTransparency = 1
                        })Play()
                        rainbow = false
                        rainbowconnectionDisconnect()
                    else
                        game.TweenServiceCreate(toggleEnabled, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            ImageTransparency = 0
                        })Play()
                        rainbow = true
                        rainbowconnection = rs.RenderSteppedConnect(function()
                ...
                onrainbow.MouseButton1ClickConnect(togglerainbow)
                --
                mouse.Moveconnect(cp)
                rgb.MouseButton1Downconnect(function()colorpicker=true end)
                dark.MouseButton1Downconnect(function()darknesss=true end)
            ...
            function ElementsNewLabel(title)
	            ...
	            if themeList.SchemeColor == Color3.fromRGB(255,255,255) then
	                UtilityTweenObject(label, {TextColor3 = Color3.fromRGB(0,0,0)}, 0.2)
	            end 
	            if themeList.SchemeColor == Color3.fromRGB(0,0,0) then
	                UtilityTweenObject(label, {TextColor3 = Color3.fromRGB(255,255,255)}, 0.2)
	            end 
                ...
                updateSectionFrame()
                UpdateSize()
                function labelFunctionsUpdateLabel(newText)
